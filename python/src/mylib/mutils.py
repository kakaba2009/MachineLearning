...
# Specification of the supported alphabet (subset of ASCII)
# 10 line feed LF
...
def sample_from_probabilities(probabilities, topn=DATASIZE):
    ...
    p = p / np.sum(p)
    return np.random.choice(DATASIZE, 1, p=p)[0]
